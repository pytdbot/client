...
def on_updateAuthorizationState(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateAuthorizationState", self, position)
        else:
            func._handler = Handler(func, "updateAuthorizationState", filters, position)
        return func
...
def on_updateMessageSendSucceeded(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateMessageSendSucceeded", self, position)
        else:
            func._handler = Handler(
...
def on_updateMessageSendFailed(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateMessageSendFailed", filters, position)
        return func
...
def on_updateMessageIsPinned(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateMessageIsPinned", filters, position)
        return func
...
def on_updateMessageContentOpened(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateMessageContentOpened", self, position)
        else:
            func._handler = Handler(
...
def on_updateMessageMentionRead(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateMessageMentionRead", self, position)
        else:
            func._handler = Handler(func, "updateMessageMentionRead", filters, position)
        return func
...
def on_updateChatPermissions(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateChatPermissions", filters, position)
        return func
...
def on_updateChatLastMessage(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateChatLastMessage", filters, position)
        return func
...
def on_updateChatDraftMessage(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateChatDraftMessage", filters, position)
        return func
...
def on_updateChatMessageSender(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateChatMessageSender", filters, position)
        return func
...
def on_updateChatReplyMarkup(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateChatReplyMarkup", filters, position)
        return func
...
def on_updateChatIsTranslatable(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateChatIsTranslatable", self, position)
        else:
            func._handler = Handler(func, "updateChatIsTranslatable", filters, position)
        return func
...
def on_updateChatIsMarkedAsUnread(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateChatIsMarkedAsUnread", self, position)
        else:
            func._handler = Handler(
...
def on_updateChatFilters(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateChatFilters", self, position)
        else:
...
def on_updateChatOnlineMemberCount(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateChatOnlineMemberCount", self, position)
        else:
            func._handler = Handler(
...
def on_updateNotificationGroup(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateNotificationGroup", filters, position)
        return func
...
def on_updateActiveNotifications(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateActiveNotifications", self, position)
        else:
            func._handler = Handler(
...
def on_updateBasicGroupFullInfo(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateBasicGroupFullInfo", self, position)
        else:
            func._handler = Handler(func, "updateBasicGroupFullInfo", filters, position)
        return func
...
def on_updateSupergroupFullInfo(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateSupergroupFullInfo", self, position)
        else:
            func._handler = Handler(func, "updateSupergroupFullInfo", filters, position)
        return func
...
def on_updateServiceNotification(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateServiceNotification", self, position)
        else:
            func._handler = Handler(
...
def on_updateFileGenerationStart(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateFileGenerationStart", self, position)
        else:
            func._handler = Handler(
...
def on_updateFileGenerationStop(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateFileGenerationStop", self, position)
        else:
            func._handler = Handler(func, "updateFileGenerationStop", filters, position)
        return func
...
def on_updateFileAddedToDownloads(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateFileAddedToDownloads", self, position)
        else:
            func._handler = Handler(
...
def on_updateGroupCallParticipant(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateGroupCallParticipant", self, position)
        else:
            func._handler = Handler(
...
def on_updateNewCallSignalingData(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateNewCallSignalingData", self, position)
        else:
            func._handler = Handler(
...
def on_updateUnreadMessageCount(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateUnreadMessageCount", self, position)
        else:
            func._handler = Handler(func, "updateUnreadMessageCount", filters, position)
        return func
...
def on_updateUnreadChatCount(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateUnreadChatCount", filters, position)
        return func
...
def on_updateInstalledStickerSets(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateInstalledStickerSets", self, position)
        else:
            func._handler = Handler(
...
def on_updateTrendingStickerSets(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateTrendingStickerSets", self, position)
        else:
            func._handler = Handler(
...
def on_updateFavoriteStickers(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateFavoriteStickers", filters, position)
        return func
...
def on_updateSavedAnimations(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateSavedAnimations", filters, position)
        return func
...
def on_updateSelectedBackground(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateSelectedBackground", self, position)
        else:
            func._handler = Handler(func, "updateSelectedBackground", filters, position)
        return func
...
def on_updateLanguagePackStrings(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateLanguagePackStrings", self, position)
        else:
            func._handler = Handler(
...
def on_updateConnectionState(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateConnectionState", filters, position)
        return func
...
def on_updateAttachmentMenuBots(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateAttachmentMenuBots", self, position)
        else:
            func._handler = Handler(func, "updateAttachmentMenuBots", filters, position)
        return func
...
def on_updateWebAppMessageSent(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateWebAppMessageSent", filters, position)
        return func
...
def on_updateActiveEmojiReactions(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateActiveEmojiReactions", self, position)
        else:
            func._handler = Handler(
...
def on_updateDefaultReactionType(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateDefaultReactionType", self, position)
        else:
            func._handler = Handler(
...
def on_updateSuggestedActions(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateSuggestedActions", filters, position)
        return func
...
def on_updateAutosaveSettings(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateAutosaveSettings", filters, position)
        return func
...
def on_updateNewChosenInlineResult(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateNewChosenInlineResult", self, position)
        else:
            func._handler = Handler(
...
def on_updateNewCallbackQuery(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateNewCallbackQuery", filters, position)
        return func
...
def on_updateNewShippingQuery(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateNewShippingQuery", filters, position)
        return func
...
def on_updateNewPreCheckoutQuery(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateNewPreCheckoutQuery", self, position)
        else:
            func._handler = Handler(
...
def on_updateNewChatJoinRequest(
    ...
    def decorator(func: Callable) -> Callable:
        if hasattr(func, "_handler"):
            ...
            func._handler = Handler(func, "updateNewChatJoinRequest", self, position)
        else:
            func._handler = Handler(func, "updateNewChatJoinRequest", filters, position)
        return func
