    ...
    def on_updateNewOauthRequest(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                if iscoroutinefunction(func):
                    self.add_handler(
                        update_type="updateNewOauthRequest",
                        func=func,
                        filters=filters,
                        position=position,
                        inner_object=False,
    ...
    def on_updateNewGroupCallMessage(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                if iscoroutinefunction(func):
                    self.add_handler(
                        update_type="updateNewGroupCallMessage",
                        func=func,
                        filters=filters,
                        position=position,
                        inner_object=False,
    ...
    def on_updateNewGroupCallPaidReaction(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                if iscoroutinefunction(func):
                    self.add_handler(
                        update_type="updateNewGroupCallPaidReaction",
                        func=func,
                        filters=filters,
                        position=position,
                        inner_object=False,
    ...
    def on_updateGroupCallMessageSendFailed(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                if iscoroutinefunction(func):
                    self.add_handler(
                        update_type="updateGroupCallMessageSendFailed",
                        func=func,
                        filters=filters,
                        position=position,
                        inner_object=False,
    ...
    def on_updateGroupCallMessagesDeleted(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                if iscoroutinefunction(func):
                    self.add_handler(
                        update_type="updateGroupCallMessagesDeleted",
                        func=func,
                        filters=filters,
                        position=position,
                        inner_object=False,
    ...
    def on_updateLiveStoryTopDonors(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                if iscoroutinefunction(func):
                    self.add_handler(
                        update_type="updateLiveStoryTopDonors",
                        func=func,
                        filters=filters,
                        position=position,
                        inner_object=False,
    ...
    def on_updateTrustedMiniAppBots(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                if iscoroutinefunction(func):
                    self.add_handler(
                        update_type="updateTrustedMiniAppBots",
                        func=func,
                        filters=filters,
                        position=position,
                        inner_object=False,
    ...
    def on_updateGroupCallMessageLevels(
        ...
        def decorator(func: Callable) -> Callable:
            if hasattr(func, "_handler"):
                ...
                if iscoroutinefunction(func):
                    self.add_handler(
                        update_type="updateGroupCallMessageLevels",
                        func=func,
                        filters=filters,
                        position=position,
                        inner_object=False,
